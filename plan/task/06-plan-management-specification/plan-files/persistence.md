...
**Purpose**: Tasks-only file containing phases, tasks, and status tracking
...
**Purpose**: Configuration artifact created by init phase
...
**Purpose**: Centralized reference management for all related resources
...
**Purpose**: Link plan to GitHub issue and git branch
...
**Purpose**: Track which files the plan will create/modify
...
**Purpose**: Link to architectural decisions documented via `adr-management` skill
...
**Purpose**: Link to interface specifications documented via `interface-management` skill
...
**Purpose**: Link to external resources (RFCs, standards, libraries)
...
**Purpose**: Track project dependencies and related plans
...
**Purpose**: Runtime artifact generated by refine phase with detailed implementation guidance
