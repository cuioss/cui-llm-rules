---
name: cui-general-development-rules
...
- Tool usage standards (references cui-diagnostic-patterns skill)
...
- Single standards file with all core rules
- Cross-references to specialized skills for details
- Delegates to research-best-practices agent for research
- Delegates to cui-diagnostic-patterns skill for tool usage details
...
**For tool patterns:** References cui-diagnostic-patterns skill
...
## Integration with cui-utility-commands Bundle

This skill integrates with other cui-utility-commands components:

### Agents
- **research-best-practices** - This skill delegates research to this agent for finding current best practices

### Skills
- **cui-diagnostic-patterns** - This skill references cui-diagnostic-patterns for detailed tool usage patterns
...
### 3. Use Proper Tools
Use Read, Write, Edit, Glob, Grep (not cat, tail, find, test via Bash). See cui-diagnostic-patterns skill for details.
...
- [x] Proper delegation to specialized skills (cui-diagnostic-patterns)
...
- cui-diagnostic-patterns skill - For detailed tool usage patterns and non-prompting file operations
