...
**References cui-diagnostic-patterns skill:**
...
- See cui-diagnostic-patterns skill for complete patterns
...
### With cui-utility-commands Bundle

**Agents:**
- **research-best-practices** - Used for researching current best practices

**Skills:**
- **cui-diagnostic-patterns** - Detailed tool usage patterns
...
- cui-java-expert agents (implementation patterns)
- cui-workflow commands (when to ask users)
- cui-plugin-development-tools (creating new components)
...
**Details:** See cui-diagnostic-patterns skill for complete patterns.
...
```markdown
Following cui-general-development-rules principle: "If in doubt, ask the user."
...
```markdown
Following cui-general-development-rules: Research current best practices.
...
```markdown
Following cui-general-development-rules: Use proper tools for file operations.
...
Part of the **cui-utility-commands** bundle - Utility commands and agents for CUI development.

## See Also

- research-best-practices agent - Comprehensive web research for current best practices
- cui-diagnostic-patterns skill - Detailed tool usage patterns for non-prompting operations
- cui-workflow bundle - Development workflow integration
- cui-plugin-development-tools bundle - Creating agents and commands following these principles
