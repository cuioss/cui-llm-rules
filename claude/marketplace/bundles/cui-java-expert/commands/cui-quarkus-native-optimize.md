---
name: cui-quarkus-native-optimize
...
**CRITICAL:** Every time you execute this command and discover a more precise, better, or more efficient approach, **YOU MUST immediately update this file** using `/cui-update-command command-name=cui-quarkus-native-optimize update="[your improvement]"` with:
