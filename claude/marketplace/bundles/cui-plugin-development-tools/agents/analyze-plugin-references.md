...
**Commands:**
```bash
Glob: claude/marketplace/bundles/*/commands/{name}.md
Glob: claude/marketplace/bundles/{bundle}/commands/{name}.md  # if bundle specified
```

**Agents:**
```bash
Glob: claude/marketplace/bundles/*/agents/{name}.md
Glob: claude/marketplace/bundles/{bundle}/agents/{name}.md  # if bundle specified
```

**Skills:**
```bash
Glob: claude/marketplace/bundles/*/skills/{name}/.
Glob: claude/marketplace/bundles/{bundle}/skills/{name}/.  # if bundle specified
```
...
**Glob:**
- Find all commands: `claude/marketplace/bundles/*/commands/*.md`
- Find all agents: `claude/marketplace/bundles/*/agents/*.md`
- Find all skills: `claude/marketplace/bundles/*/skills/*/.`
