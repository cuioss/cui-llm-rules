...
**CRITICAL:** Every time you execute this command, **YOU MUST immediately update this file** using `/cui-update-command command-name=cui-js-implement-tests update="[your improvement]"` with improvements discovered.
