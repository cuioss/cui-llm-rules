...
2. Update docs immediately when code changes
3. Be specific about constraints and edge cases
4. Document all error conditions
5. Provide realistic usage examples
6. Run ESLint validation before committing
7. Focus on "why" and "how to use", not just "what"

## Common Mistakes

- Omitting required tags (@param, @returns, @throws)
- Vague descriptions ("Processes the data")
- Wrong parameter names (must match function signature)
- Incorrect types (use lowercase: string, number, boolean)
