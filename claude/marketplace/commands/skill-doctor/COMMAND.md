...
- Exclude `skill-doctor` itself from analysis
...
✅ Referenced by 3 agents:
  - project-builder (claude/agents/project-builder.md)
...
- <skill-1>: <issue>
- <skill-2>: <issue>
Re-run skill-doctor on these skills to fix.
</if>
...
/skill-doctor cui-java-unit-testing
```
...
Run `skill-doctor` periodically to:
...
- skill-doctor focuses on: structure, references, configuration, integration
