...
2. Invoke issue-manager agent using Task tool:
...
2. Invoke project-builder agent using Task tool:
...
**Objective**: Implement ONE task from the plan using issue-implementer agent.
