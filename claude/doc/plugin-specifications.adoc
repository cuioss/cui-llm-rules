...
|`repository`
|Repository URL as a string. Example: `"https://github.com/owner/repo.git"`
...
|`commands`
|Array of paths to command `.md` files. **MUST include `.md` extension**. Example: `"./commands/cui-verify-build.md"`
...
"commands": ["./commands/cui-verify-build.md"]
...
**Validation**: Use `/cui-diagnose-commands` or `/cui-diagnose-agents` to verify frontmatter
...
```json
{
  ...
  "commands": [
    ...
    "./commands/cui-setup-project-permissions.md"
  ]
}
```
