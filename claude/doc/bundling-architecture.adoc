...
```json
{
  ...
  "version": "1.0.0",
  "description": "Standalone utility tools including git commit management",
  ...
  "commands": [
    ...
    "./commands/cui-manage-web-permissions.md"
  ],
  "skills": [
    "./skills/cui-diagnostic-patterns",
    "./skills/permission-management"
  ]
}
```
