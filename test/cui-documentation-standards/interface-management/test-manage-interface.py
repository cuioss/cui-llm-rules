...
class TestManageInterface(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.script_path = (
            ...
            / "marketplace/bundles/cui-documentation-standards/skills/interface-management/scripts/manage-interface.py"
        )
    ...
    def test_create_interface(self):
        ...
        result = self.run_script(
            "create", "--title", "User Service API", "--type", "REST_API"
        )
        self.assertEqual(result.returncode, 0)
        output = json.loads(result.stdout)
        self.assertTrue(output["success"])
    ...
    def test_create_interface_requires_type(self):
        ...
        result = self.run_script("create", "--title", "Some Interface")
    ...
    def test_create_multiple_interfaces(self):
        ...
        self.run_script("create", "--title", "First", "--type", "REST_API")
        self.run_script("create", "--title", "Second", "--type", "Event")
        result = self.run_script("create", "--title", "Third", "--type", "gRPC")
    ...
    def test_list_interfaces(self):
        ...
        self.run_script("create", "--title", "API One", "--type", "REST_API")
        self.run_script("create", "--title", "API Two", "--type", "Event")
    ...
    def test_list_interfaces_filter_type(self):
        ...
        self.run_script("create", "--title", "REST One", "--type", "REST_API")
        self.run_script("create", "--title", "Event One", "--type", "Event")
        self.run_script("create", "--title", "REST Two", "--type", "REST_API")

        result = self.run_script("list", "--type", "REST_API")
        output = json.loads(result.stdout)
        self.assertTrue(output["success"])
        self.assertEqual(output["count"], 2)
    ...
    def test_read_interface(self):
        ...
        self.run_script("create", "--title", "Test Read", "--type", "Database")
    ...
    def test_delete_requires_force(self):
        ...
        self.run_script("create", "--title", "Delete Test", "--type", "File")
    ...
    def test_delete_with_force(self):
        ...
        self.run_script("create", "--title", "Delete Me", "--type", "Other")
    ...
    def test_invalid_interface_type(self):
        ...
        result = self.run_script(
            "create", "--title", "Bad Interface", "--type", "INVALID"
        )
        self.assertNotEqual(result.returncode, 0)
    ...
    def test_filename_sanitization(self):
        ...
        result = self.run_script(
            "create", "--title", "API/Service with Special!", "--type", "REST_API"
        )
        output = json.loads(result.stdout)
        self.assertTrue(output["success"])
