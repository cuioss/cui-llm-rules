...
SCRIPT_PATH = get_script_path('cui-plugin-development-tools', 'plugin-maintain', 'maintain.py')
...
def test_analyze_real_agent():
    ...
    agent_file = PROJECT_ROOT / 'marketplace' / 'bundles' / 'cui-plugin-development-tools' / 'agents' / 'plugin-specify-agent.md'
...
def test_readme_real_bundle():
    ...
    bundle_path = PROJECT_ROOT / 'marketplace' / 'bundles' / 'cui-plugin-development-tools'
