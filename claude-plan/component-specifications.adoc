...
Verifies skills structure, YAML frontmatter, and cross-references.
...
**Complete specification**: xref:plugin-structure.adoc#path-resolution[Plugin Structure § Path Resolution]
