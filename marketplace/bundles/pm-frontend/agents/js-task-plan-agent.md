...
model: sonnet
skills: pm-frontend:js-task-plan, pm-core:general-development-rules
---

# JavaScript Task Plan Agent

Constrained specialist for JavaScript task planning. Delegates to `pm-frontend:js-task-plan` skill.
...
```
Skill: pm-frontend:js-task-plan
...
component: "pm-frontend:js-task-plan"
