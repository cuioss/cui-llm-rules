...
model: sonnet
skills: pm-frontend:js-solution-outline, pm-core:general-development-rules
---

# JavaScript Solution Outline Agent

Constrained specialist for JavaScript solution outline creation. Delegates to `pm-frontend:js-solution-outline` skill.
...
```
Skill: pm-frontend:js-solution-outline
...
- Create tasks (wrong scope - that's js-task-plan-agent)
...
component: "pm-frontend:js-solution-outline"
