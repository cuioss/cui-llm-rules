...
- Reference `pm-frontend:cui-javascript-linting` standards

### Web Components
When task involves custom elements:
- Check for LitElement usage
- Identify component registration patterns
- Reference `pm-frontend:cui-javascript` standards

### Testing
When task involves testing:
- Check for Jest configuration
- Identify Cypress E2E tests
- Reference `pm-frontend:cui-javascript-unit-testing` standards
...
**Caller**: `pm-frontend:js-solution-outline-agent`
...
- `pm-frontend:cui-javascript-linting` - ESLint/Prettier standards
- `pm-frontend:cui-javascript-unit-testing` - Jest testing standards
- `pm-frontend:cui-jsdoc` - Documentation standards
