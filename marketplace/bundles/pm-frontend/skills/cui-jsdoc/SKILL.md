...
1. **Run violation analysis script**
   ...
   Script: `pm-frontend:cui-jsdoc` → `jsdoc.py`
   ...
   # Analyze single file
   python3 .plan/execute-script.py pm-frontend:cui-jsdoc:jsdoc analyze --file src/utils/formatter.js

   # Analyze only for missing JSDoc (skip syntax checks)
   python3 .plan/execute-script.py pm-frontend:cui-jsdoc:jsdoc analyze --directory src/ --scope missing

   # Analyze only JSDoc syntax issues
   python3 .plan/execute-script.py pm-frontend:cui-jsdoc:jsdoc analyze --directory src/ --scope syntax
   ```
