...
python3 .plan/execute-script.py pm-workflow:manage-tasks:manage-task add \
  ...
  --steps \
    ...
    "Add unit tests (load pm-frontend:cui-javascript-unit-testing)" \
    "Add JSDoc (load pm-frontend:cui-jsdoc)" \
    "Follow CUI patterns (load pm-frontend:cui-javascript)" \
...
4. Add JSDoc (load pm-frontend:cui-jsdoc)
...
4. Add unit tests (load pm-frontend:cui-javascript-unit-testing)
5. Add E2E tests if interactive (load pm-frontend:cui-cypress)
6. Add JSDoc (load pm-frontend:cui-jsdoc)
...
**Caller**: `pm-frontend:js-task-plan-agent`
...
- `pm-frontend:cui-javascript` - Core JavaScript patterns
- `pm-frontend:cui-javascript-unit-testing` - Jest testing standards
- `pm-frontend:cui-jsdoc` - JSDoc documentation standards
- `pm-frontend:cui-cypress` - E2E testing (when applicable)
