...
2. **Record lesson** with:
   - Component: `{type: "command", name: "js-refactor-code", bundle: "pm-frontend"}`
...
```
SlashCommand: /pm-frontend:js-implement-code task="Fix violation using cui-javascript standards.
