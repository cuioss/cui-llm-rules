...
2. **Record lesson** with:
   - Component: `{type: "command", name: "js-fix-jsdoc", bundle: "pm-frontend"}`
...
```bash
# Analyze directory
python3 .plan/execute-script.py pm-frontend:cui-jsdoc:jsdoc analyze --directory src/

# Analyze specific file
python3 .plan/execute-script.py pm-frontend:cui-jsdoc:jsdoc analyze --file {files}
```
...
```
SlashCommand: /pm-frontend:js-implement-code task="Add JSDoc documentation for {violation.target}.
...
- Skill: `pm-frontend:cui-jsdoc` - Analyze JSDoc Violations workflow
