...
2. **Record lesson** with:
   - Component: `{type: "command", name: "js-maintain-tests", bundle: "pm-frontend"}`
...
```
SlashCommand: /pm-frontend:js-generate-coverage
...
```
SlashCommand: /pm-frontend:js-implement-tests task="Improve test quality using cui-javascript-maintenance test-quality-standards.md:
