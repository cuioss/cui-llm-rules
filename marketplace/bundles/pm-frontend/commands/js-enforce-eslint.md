...
2. **Record lesson** with:
   - Component: `{type: "command", name: "js-enforce-eslint", bundle: "pm-frontend"}`
...
```
SlashCommand: /pm-frontend:js-implement-code task="Fix ESLint violation: {violation.message}
...
- Skill: `pm-frontend:cui-javascript-linting` - ESLint standards
