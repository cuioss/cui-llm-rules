...
**Gradle:**
```
Skill: pm-builder:builder-gradle-dependencies
Workflow: {action}
...
- Skill: `pm-builder:builder-pom-maintenance` - Maven POM maintenance
- Skill: `pm-builder:builder-gradle-dependencies` - Gradle dependency management
- Skill: `pm-builder:builder-npm-rules` - npm package maintenance
