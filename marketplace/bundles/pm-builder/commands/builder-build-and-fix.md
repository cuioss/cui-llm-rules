...
```
Skill: pm-builder:environment-detection
...
|--------|-------|----------|
| maven | `pm-builder:builder-maven-rules` | Execute Maven Build |
| gradle | `pm-builder:builder-gradle-rules` | Execute Gradle Build |
| npm | `pm-builder:builder-npm-rules` | Execute npm Build |
...
```
If `push=true`: Invoke `/pm-workflow:commit-changes`
...
- Skill: `pm-builder:environment-detection` - Build system auto-detection
- Skill: `pm-builder:builder-maven-rules` - Maven builds
- Skill: `pm-builder:builder-gradle-rules` - Gradle builds
- Skill: `pm-builder:builder-npm-rules` - npm builds
