...
```
Skill: pm-builder:builder-pom-maintenance
```

## Scripts

Script: `pm-builder:builder-maven-rules` → `maven.py`
...
```bash
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven execute \
    --goals "{goals}" \
    --profile {profile} \
    --module {module} \
    --timeout {timeout}
...
```bash
# Basic build
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven execute --goals "clean install"

# Module-specific build
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven execute --goals "clean install" --module auth-service

# With profile
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven execute --goals "clean verify" --profile pre-commit

# Coverage build
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven execute --goals "clean test" --profile coverage

# Native image with extended timeout
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven execute --goals "clean package -Dnative" --timeout 600000
```
...
```bash
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven parse \
...
```bash
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven find-module \
...
```bash
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven search-markers \
...
```bash
python3 .plan/execute-script.py pm-builder:builder-maven-rules:maven check-warnings \
...
- `pm-builder:builder-pom-maintenance` - POM maintenance (dependencies, BOMs, scopes)
- `pm-java:cui-javadoc` - JavaDoc standards
- `pm-java:cui-java-unit-testing` - Test standards
