...
Script: `pm-builder:builder-gradle-rules` → `gradle.py`
...
1. **Execute Gradle**:
   ...
   ```bash
   python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle execute \
       --tasks "{tasks}" \
       --project {project} \
       --skip-tests \
       --timeout {timeout}
...
2. **Parse Output**:
   ...
   ```bash
   python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle parse \
...
```bash
python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle parse --log <path> --mode <mode>
```
...
python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle find-project --project-name {project_name}

# Validate explicit path
python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle find-project --project-path {project_path}
```
...
```bash
python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle search-markers \
...
2. Execute categorization:
   ...
   ```bash
   python3 .plan/execute-script.py pm-builder:builder-gradle-rules:gradle check-warnings \
