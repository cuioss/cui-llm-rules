...
```
cui-java-expert         (Java development)
cui-frontend-expert     (Frontend development)
cui-documentation-standards (Documentation)
```
...
**Example**: `cui-plugin-development-tools`
```
...
- Example: `cui-java-expert:cui-java-core`
