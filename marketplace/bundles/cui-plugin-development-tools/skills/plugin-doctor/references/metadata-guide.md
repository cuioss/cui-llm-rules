...
```
# ✅ Correct
Directory: marketplace/bundles/cui-java-expert/
plugin.json: {"name": "cui-java-expert"}
...
plugin.json: {"name": "cui-java-expert"}  (mismatch)
```
...
```json
{
  "bundle_name": "cui-java-expert",
  "plugin_json_path": "marketplace/bundles/cui-java-expert/plugin.json",
  "validation": {
    "schema_valid": true,
