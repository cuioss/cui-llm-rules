#!/usr/bin/env python3
"""
Check for duplicate knowledge in skill references.

Usage: check-duplication.py <skill_path> <content_file>

Compares new content against existing references to detect duplication.
"""
...
def check_duplication(skill_path: str, content_file: str) -> dict:
    ...
    for ref_file in refs_dir.glob('*.md'):
        ...
        existing_normalized = normalize_text(existing_content)
...
def main():
    ...
    result = check_duplication(skill_path, content_file)
