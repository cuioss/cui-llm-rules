...
**marketplace_inventory** (required) - JSON inventory from scan-marketplace-inventory.sh script containing all marketplace bundles, agents, commands, and skills
...
- If marketplace_inventory not provided: "ERROR: marketplace_inventory parameter required - pass JSON from scan-marketplace-inventory.sh script"
