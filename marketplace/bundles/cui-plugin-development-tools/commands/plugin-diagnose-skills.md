...
**Skill** (marketplace-inventory, diagnostic/architecture patterns), **Glob** (skill discovery), **Task** (agent orchestration), **Edit** (fixes), **AskUserQuestion** (risky fix approval).
