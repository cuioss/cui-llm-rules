...
2. **Run Violation Analysis Script**
   ...
   Script: `pm-java:cui-java-core` → `java-core.py`

   ```bash
   python3 .plan/execute-script.py pm-java:cui-java-core:java-core analyze-logging --directory {target}
   ```
...
2. **Run Documentation Script**
   ...
   ```bash
   python3 .plan/execute-script.py pm-java:cui-java-core:java-core document-logrecord --holder {holder_class} --output {output_file}
   ```
...
1. **Validate Task Description**
   ...
   ```bash
   python3 .plan/execute-script.py pm-java:cui-java-core:java-core verify-params --description "{description}"
   ```
...
- **Location**: `pm-java:cui-java-core/verify-implementation-params`
