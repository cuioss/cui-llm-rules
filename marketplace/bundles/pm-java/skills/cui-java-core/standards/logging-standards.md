...
**Note**: The `cui-java-unit-testing` skill is part of the `pm-java` marketplace bundle. If the skill is not available, implement basic logger testing using JUnit assertions with `java.util.logging.Handler` for log message verification.
