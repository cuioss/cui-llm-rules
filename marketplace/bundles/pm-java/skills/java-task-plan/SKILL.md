...
python3 .plan/execute-script.py pm-workflow:manage-tasks:manage-task add \
  ...
  --steps \
    ...
    "Add unit tests (load pm-java:cui-java-unit-testing)" \
    "Add JavaDoc (load pm-java:cui-javadoc)" \
    "Follow CUI patterns (load pm-java:cui-java-core)" \
    "Verify build passes"
```
...
4. Add unit tests (load pm-java:cui-java-unit-testing)
5. Add JavaDoc (load pm-java:cui-javadoc)
...
4. Add integration tests (load pm-java:cui-java-unit-testing)
5. Add JavaDoc (load pm-java:cui-javadoc)
6. Verify build passes
```
...
- `pm-java:cui-java-unit-testing` - Testing standards
- `pm-java:cui-javadoc` - Documentation standards
- `pm-java:cui-java-cdi` - CDI/Quarkus patterns (when applicable)
