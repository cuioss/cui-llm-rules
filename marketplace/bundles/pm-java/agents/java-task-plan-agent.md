...
model: sonnet
skills: pm-java:java-task-plan, pm-core:general-development-rules
---

# Java Task Plan Agent

Constrained specialist for Java task planning. Delegates to `pm-java:java-task-plan` skill.
...
component: "pm-java:java-task-plan"
