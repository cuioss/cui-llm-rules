...
model: sonnet
skills: pm-java:java-solution-outline, pm-core:general-development-rules
---

# Java Solution Outline Agent

Constrained specialist for Java solution outline creation. Delegates to `pm-java:java-solution-outline` skill.
...
```
Skill: pm-java:java-solution-outline
...
component: "pm-java:java-solution-outline"
