...
```
Task:
  subagent_type: pm-java:java-fix-build-agent
...
```
Task:
  subagent_type: pm-java:java-implement-tests-agent
...
```
Task:
  subagent_type: pm-java:java-fix-tests-agent
...
```
Task:
  subagent_type: pm-java:java-verify-agent
...
2. **Record lesson** with:
   - Component: `{type: "command", name: "java-full-workflow", bundle: "pm-java"}`
