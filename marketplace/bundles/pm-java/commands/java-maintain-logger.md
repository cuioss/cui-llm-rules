...
2. **Record lesson** with:
   - Component: `{type: "command", name: "java-maintain-logger", bundle: "pm-java"}`
...
```
SlashCommand: /pm-java:java-implement-code task="Migrate logger to CuiLogger in {file}.
...
```
SlashCommand: /pm-java:java-implement-code task="Add LogRecord usage in {file}.
...
```
SlashCommand: /pm-java:java-implement-code task="Create/update LogMessages class for module {module}.
...
- **pm-builder:builder-maven-rules skill** - Build output parsing
...
- `pm-builder:builder-maven-rules` skill - Maven standards and output parsing
