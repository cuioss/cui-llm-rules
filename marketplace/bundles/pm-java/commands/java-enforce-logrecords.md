...
2. **Record lesson** with:
   - Component: `{type: "command", name: "java-enforce-logrecords", bundle: "pm-java"}`
...
- Skill: `pm-java:cui-java-core` - Logging standards, enforcement patterns, and workflows
...
- Skill: `pm-builder:builder-maven-rules` - Maven standards and build output parsing
