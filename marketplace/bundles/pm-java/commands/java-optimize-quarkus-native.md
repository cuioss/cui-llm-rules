...
2. **Record lesson** with:
   - Component: `{type: "command", name: "java-optimize-quarkus-native", bundle: "pm-java"}`
...
- Skill: `pm-java:cui-java-cdi` - Contains `standards/quarkus-native.md` with detailed technical guidance
