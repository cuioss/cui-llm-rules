...
- `/js-implement-code` - Self-contained implementation command (Layer 2)
- `/js-implement-tests` - Self-contained test command (Layer 2)
- `/js-generate-coverage` - Coverage generation/analysis (Layer 2)
