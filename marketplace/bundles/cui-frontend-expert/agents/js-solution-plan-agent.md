---
name: js-solution-plan-agent
description: Analyze JavaScript codebase and decompose request into goals
tools: Read, Write, Edit, Glob, Grep, Skill
model: sonnet
skills: cui-frontend-expert:js-solution-plan, general-tools:general-development-rules
---

# JavaScript Goals Agent

Constrained specialist for JavaScript goal decomposition. Delegates to `cui-frontend-expert:js-solution-plan` skill.
...
```
Skill: cui-frontend-expert:js-solution-plan
...
component: "cui-frontend-expert:js-solution-plan"
