...
model: sonnet
skills: cui-frontend-expert:js-goals, general-tools:general-development-rules
---

# JavaScript Goals Agent

Constrained specialist for JavaScript goal decomposition. Delegates to `cui-frontend-expert:js-goals` skill.
...
```
Skill: cui-frontend-expert:js-goals
...
- You analyze JavaScript code to create GOAL-N goals from the request
...
component: "cui-frontend-expert:js-goals"
