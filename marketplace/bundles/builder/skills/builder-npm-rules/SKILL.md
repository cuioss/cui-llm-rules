...
python3 .plan/execute-script.py builder:builder-npm-rules:npm execute --command "run build" --workspace e-2-e-playwright

# Playwright tests with environment
python3 .plan/execute-script.py builder:builder-npm-rules:npm execute --command "playwright test" --env "CI=true"

# Lint with extended timeout
python3 .plan/execute-script.py builder:builder-npm-rules:npm execute --command "run lint" --timeout 180000
```
