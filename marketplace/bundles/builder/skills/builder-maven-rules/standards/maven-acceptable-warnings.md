...
Use the `plan-marshall-core:run-config` skill for all configuration access.
...
1. **Load patterns**: Activate `plan-marshall-core:run-config` to read `maven.acceptable_warnings`
