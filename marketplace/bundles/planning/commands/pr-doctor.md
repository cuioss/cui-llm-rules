...
Record improvements: `Skill: plan-marshall-core:manage-lessons-learned` with component `{type: "command", name: "pr-doctor", bundle: "planning"}`
...
```
Skill: planning:pr-workflow
Skill: planning:sonar-workflow
