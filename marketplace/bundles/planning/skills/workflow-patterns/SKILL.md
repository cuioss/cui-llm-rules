...
**Format**: Handoffs use TOON (Token-Oriented Object Notation) format for 30-60% token reduction vs JSON. See `general-tools:toon-usage` skill for TOON format reference.
...
- See `general-tools:toon-usage` for TOON specification and usage patterns
