...
```bash
python3 {write-lesson.py path} --component "planning:plan-verify" --category {bug|improvement|anti-pattern} --title "Brief description" --detail "What happened, why, workaround, suggested fix"
```
