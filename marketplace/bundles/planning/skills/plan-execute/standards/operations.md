...
```
Task:
  subagent_type: builder:maven-builder
...
```
Task:
  subagent_type: cui-java-expert:java-quality-agent
...
```
Task:
  subagent_type: cui-java-expert:java-fix-javadoc-agent
...
Only execute if unexpected behavior occurred. Follow `plan-marshall-core:script-runner` Error Handling workflow.
