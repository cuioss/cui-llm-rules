...
1. **Activate skill**: `Skill: plan-marshall-core:lessons-learned`
...
1. Activate `plan-marshall-core:run-config` skill to check for module configuration:
   ```
...
**Read configuration:**
1. Activate `plan-marshall-core:run-config` skill:
   ```
   Skill: plan-marshall-core:run-config
   Workflow: Read Configuration
...
- Store results using `plan-marshall-core:run-config` skill:
  ```
  Skill: plan-marshall-core:run-config
