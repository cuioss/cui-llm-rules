...
```
Task:
  subagent_type: cui-java-expert:java-implement-tests-agent
...
```
Task:
  subagent_type: cui-java-expert:java-fix-tests-agent
...
```
Task:
  subagent_type: cui-java-expert:java-verify-agent
...
2. **Record lesson** with:
   - Component: `{type: "command", name: "java-full-workflow", bundle: "cui-java-expert"}`
