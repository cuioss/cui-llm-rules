...
The caller can then invoke `/plugin-update-agent agent-name=log-record-documenter update="[improvement]"` based on your report.
...
- `java-enforce-logrecords` command - Enforce LogRecord implementation standards
