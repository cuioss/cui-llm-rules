...
The caller can then invoke `/cui-plugin-development-tools:plugin-update-agent agent-name=logging-violation-analyzer update="[your improvement]"` based on your report.
...
- `/java-enforce-logrecords` - Orchestrates violation fixing (Layer 2)
