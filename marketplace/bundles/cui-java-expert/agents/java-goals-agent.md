---
name: java-goals-agent
description: Analyze Java codebase and decompose request into goals
tools: Read, Write, Edit, Glob, Grep, Skill
model: sonnet
skills: cui-java-expert:java-goals, general-tools:general-development-rules
---

# Java Goals Agent

Constrained specialist for Java goal decomposition. Delegates to `cui-java-expert:java-goals` skill.
...
```
Skill: cui-java-expert:java-goals
...
component: "cui-java-expert:java-goals"
