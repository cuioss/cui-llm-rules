...
**Role**: Domain planning skill for Java implementation tasks. Transforms goals into executable tasks by applying Java-specific knowledge and writing TASKs directly.
