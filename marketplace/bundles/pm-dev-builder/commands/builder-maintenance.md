...
allowed-tools: Write, Bash, Skill, Task
---
...
```
Skill: pm-dev-builder:environment-detection
...
**Gradle:**
```
Skill: pm-dev-builder:builder-gradle-dependencies
Workflow: {action}
...
- Skill: `pm-dev-builder:environment-detection` - Build system auto-detection
- Skill: `pm-dev-builder:builder-pom-maintenance` - Maven POM maintenance
- Skill: `pm-dev-builder:builder-gradle-dependencies` - Gradle dependency management
- Skill: `pm-dev-builder:builder-npm-rules` - npm package maintenance
