...
```bash
python3 .plan/execute-script.py pm-dev-builder:environment-detection:build-env detect --project-dir .
```
...
Script: `pm-dev-builder:environment-detection` → `build-env.py`
