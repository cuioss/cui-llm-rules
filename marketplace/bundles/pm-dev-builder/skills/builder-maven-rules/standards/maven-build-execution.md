...
**Storage**: Use `pm-core:run-config` skill for duration tracking.
...
- [Integration Testing](../../../../pm-java/skills/cui-java-unit-testing/standards/integration-testing.md) - Maven Surefire/Failsafe configuration
