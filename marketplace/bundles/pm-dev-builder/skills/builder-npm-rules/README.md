...
**Usage:**
```bash
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm execute --command "run test"
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm execute --command "playwright test" --workspace e-2-e-playwright
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm execute --command "run build" --env "NODE_ENV=production"
```
...
**Usage:**
```bash
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm parse --log target/npm-output-2025-11-26.log
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm parse --log build.log --mode structured
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm parse --log test.log --mode errors
```
...
python3 .plan/execute-script.py pm-dev-builder:builder-npm-rules:npm parse --log target/npm-output.log
```
