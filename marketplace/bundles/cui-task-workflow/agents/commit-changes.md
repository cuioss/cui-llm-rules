...
The caller can then invoke the update tool using `/plugin-update-agent agent-name=commit-changes update="[your improvement]"` to apply your suggested enhancement.
