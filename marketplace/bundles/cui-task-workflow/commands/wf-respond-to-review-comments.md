---
name: wf-respond-to-review-comments
...
**CRITICAL:** Every time you execute this command and discover a more precise, better, or more efficient approach, **YOU MUST immediately update this file** using `/plugin-update-command command-name=wf-respond-to-review-comments update="[your improvement]"` with:
...
```
/wf-respond-to-review-comments (Pattern 3 orchestrator)
