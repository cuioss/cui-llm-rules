...
# Navigate: scripts -> work-log -> skills -> cui-task-workflow -> bundles -> marketplace -> bundles -> cui-utilities -> skills -> file-operations-base -> scripts
MARKETPLACE_DIR = SCRIPT_DIR.parents[4]  # marketplace/bundles/cui-task-workflow/skills/work-log -> marketplace
