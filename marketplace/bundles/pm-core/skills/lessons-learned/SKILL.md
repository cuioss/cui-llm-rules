...
Script: `pm-core:lessons-learned:manage-lesson`
...
```bash
python3 .plan/execute-script.py pm-core:lessons-learned:manage-lesson update \
  --id 2025-12-02-001 \
  [--applied true|false] \
...
```bash
python3 .plan/execute-script.py pm-core:lessons-learned:manage-lesson list \
  [--component maven-build] \
  [--category bug] \
  [--applied true|false]
```
...
```bash
python3 .plan/execute-script.py pm-core:lessons-learned:manage-lesson from-error \
