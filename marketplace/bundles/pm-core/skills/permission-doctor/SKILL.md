...
**Input**:
```bash
python3 .plan/execute-script.py pm-core:permission-doctor:permission-doctor detect-redundant \
...
**Input**:
```bash
python3 .plan/execute-script.py pm-core:permission-doctor:permission-doctor detect-suspicious \
