...
```bash
python3 .plan/execute-script.py pm-core:manage-memories:{operation} [--category {category}] [--identifier {identifier}] [--content '{content}']
```
...
python3 .plan/execute-script.py pm-core:manage-memories:manage-memory save --category context --identifier "feature-auth" --content '{"notes": "Working on auth feature"}'

# Load memory file
python3 .plan/execute-script.py pm-core:manage-memories:manage-memory load --category context --identifier "2025-12-02-feature-auth"

# List context files from last 7 days
python3 .plan/execute-script.py pm-core:manage-memories:manage-memory list --category context --since 7d

# Find files matching pattern
python3 .plan/execute-script.py pm-core:manage-memories:manage-memory query --pattern "auth*" --category context

# Cleanup old context files
python3 .plan/execute-script.py pm-core:manage-memories:manage-memory cleanup --category context --older-than 7d
```
...
```bash
python3 .plan/execute-script.py pm-core:manage-memories:manage-memory validate {file_path}
```
...
| Script | Notation |
|--------|----------|
| manage-memory | `pm-core:manage-memories` |
| validate-memory | `pm-core:manage-memories` |
