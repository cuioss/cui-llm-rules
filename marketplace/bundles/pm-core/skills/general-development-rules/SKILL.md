...
**Research Execution:**
```
Task: pm-core:research-best-practices
```
...
```
Task:
  subagent_type: pm-core:research-best-practices
...
## Integration with pm-core Bundle

This skill integrates with other pm-core components:
