---
name: cui-requirements:requirements-authoring
...
- **cui-requirements:setup** - Provides initial structure that authoring populates
- **cui-requirements:planning** - Planning tasks trace to requirements created here
- **cui-requirements:traceability** - Links authored specs to implementation code
- **cui-documentation:cui-documentation** - General AsciiDoc formatting standards
- **cui-java-expert:cui-javadoc** - JavaDoc standards for referencing requirements
