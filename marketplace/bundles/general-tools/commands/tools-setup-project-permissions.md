...
2. **Record lesson** with:
   - Component: `{type: "command", name: "tools-setup-project-permissions", bundle: "general-tools"}`
...
Activate `general-tools:manage-run-configuration` skill to read user-approved suspicious permissions:
...
**Bundle Wildcards:**
- Skills: `Skill(cui-documentation-standards:*)`, `Skill(cui-frontend-expert:*)`, `Skill(cui-java-expert:*)`, `Skill(builder:*)`, `Skill(cui-plugin-development-tools:*)`, `Skill(cui-requirements:*)`, `Skill(planning:*)`, `Skill(general-tools:*)`
- SlashCommands: `SlashCommand(/cui-documentation-standards:*)`, `SlashCommand(/cui-frontend-expert:*)`, `SlashCommand(/cui-java-expert:*)`, `SlashCommand(/builder:*)`, `SlashCommand(/cui-plugin-development-tools:*)`, `SlashCommand(/cui-requirements:*)`, `SlashCommand(/planning:*)`, `SlashCommand(/general-tools:*)`
...
Activate `general-tools:manage-run-configuration` skill to record execution results:
...
- `general-tools:script-runner` - Skill for script path resolution
