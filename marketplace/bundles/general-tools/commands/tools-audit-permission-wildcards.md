...
Activate the `general-tools:permission-management` skill and execute the **Audit Permission Wildcards** workflow.
...
- `general-tools:permission-management` - Skill containing the audit workflow
