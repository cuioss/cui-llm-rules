...
```bash
echo '<inventory-json>' | python3 .plan/execute-script.py general-tools:permission-management:permission generate-wildcards
```
...
**Input**:
```bash
echo '{inventory_json}' | python3 .plan/execute-script.py general-tools:permission-management:permission generate-wildcards
```
...
**Input**:
```bash
python3 .plan/execute-script.py general-tools:permission-management:permission detect-redundant --global-settings {global_path} --local-settings {local_path}
```
...
**Input**:
```bash
python3 .plan/execute-script.py general-tools:permission-management:permission detect-suspicious --settings {settings_path} [--approved-file {run_config_path}]
```
...
**Input**:
```bash
python3 .plan/execute-script.py general-tools:permission-management:permission consolidate --settings {settings_path} [--dry-run]
```
...
**Input**:
```bash
python3 .plan/execute-script.py general-tools:permission-management:permission ensure-wildcards --settings {settings_path} --marketplace-json {marketplace_path} [--dry-run]
```
...
**Input**:
```bash
python3 .plan/execute-script.py general-tools:permission-management:permission apply-fixes --settings {settings_path} [--dry-run]
```
