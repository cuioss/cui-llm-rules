...
| Example |
|---------|
| `planning:manage-files` |
| `builder:builder-maven-rules` |
...
```
2025-12-08T10:30:00	planning:manage-files	add	0	0.15s
2025-12-08T10:30:05	builder:builder-maven-rules	execute	0	45.23s
```

**Error entries** (detailed, multi-line):
```
2025-12-08T10:31:00	planning:manage-files	add	1	0.23s	ERROR
