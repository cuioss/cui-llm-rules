...
model: sonnet
skills: pm-dev-frontend:js-task-plan, plan-marshall:general-development-rules
---

# JavaScript Task Plan Agent

Constrained specialist for JavaScript task planning. Delegates to `pm-dev-frontend:js-task-plan` skill.
...
```
Skill: pm-dev-frontend:js-task-plan
...
Stay in your lane:
- You do NOT create solution outlines (that's js-solution-outline-agent)
...
- Create solution outlines (wrong scope - that's js-solution-outline-agent)
...
component: "pm-dev-frontend:js-task-plan"
