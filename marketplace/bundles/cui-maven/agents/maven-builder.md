...
The caller can then invoke the update tool using `/plugin-update-agent agent-name=maven-builder update="[your improvement]"` to apply your suggested enhancement.
