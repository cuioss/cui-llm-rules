...
| **outline** | `pm-workflow:solution-outline` | [solution-outline-skill-contract.md](solution-outline-skill-contract.md) |
| **plan** | `pm-workflow:task-plan` | [task-plan-skill-contract.md](task-plan-skill-contract.md) |
...
| **Domain knowledge** | `resolve-domain-skills --domain {domain} --profile {profile}` | By workflow skill |
