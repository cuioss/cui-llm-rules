...
| Task Contract | `pm-workflow:plan-wf-skill-api/standards/task-contract.md` | Task structure |
...
- Example: `pm-dev-java:junit-core`, `pm-dev-frontend:cui-javascript-unit-testing`

This workflow skill defines HOW the agent executes tests - it is NOT a loadable tier.
