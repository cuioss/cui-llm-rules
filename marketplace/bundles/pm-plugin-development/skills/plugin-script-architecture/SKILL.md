...
For script execution patterns, see: `plan-marshall:script-executor`
...
- `plan-marshall:script-executor` - Script execution, notation resolution, plan-marshall command
