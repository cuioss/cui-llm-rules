...
- **Expected**: Use `python3 .plan/execute-script.py pm-workflow:manage-lifecycle:manage-lifecycle read`
...
### Actual State
```toon
[Output from pm-workflow:manage-lifecycle:manage-lifecycle read]
```
...
Should use: python3 .plan/execute-script.py pm-workflow:manage-lifecycle:manage-lifecycle read --plan-id my-plan
```

**Note**: Script notation is `pm-workflow:manage-lifecycle:manage-lifecycle` (skill name matches script name).
