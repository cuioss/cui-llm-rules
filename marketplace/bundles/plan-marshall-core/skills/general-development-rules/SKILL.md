...
- Tool usage standards (references diagnostic-patterns skill)
...
**Research Execution:**
```
Task: plan-marshall-core:research-best-practices
```
...
- Delegates to diagnostic-patterns skill for tool usage details
...
**For tool patterns:** References diagnostic-patterns skill
...
```
Task:
  subagent_type: plan-marshall-core:research-best-practices
...
## Integration with general-tools Bundle

This skill integrates with other general-tools components:

### Agents
- **research-best-practices** - This skill delegates research to this agent for finding current best practices

### Skills
- **diagnostic-patterns** - This skill references diagnostic-patterns for detailed tool usage patterns
...
### 3. Use Proper Tools
Use Read, Write, Edit, Glob, Grep (not cat, tail, find, test via Bash). See diagnostic-patterns skill for details.
...
- [x] Proper delegation to specialized skills (diagnostic-patterns)
...
- diagnostic-patterns skill - For detailed tool usage patterns and non-prompting file operations
