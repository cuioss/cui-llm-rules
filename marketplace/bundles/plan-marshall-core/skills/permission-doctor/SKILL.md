...
**Input**:
```bash
python3 .plan/execute-script.py plan-marshall-core:permission-doctor:permission-doctor detect-redundant \
...
**Input**:
```bash
python3 .plan/execute-script.py plan-marshall-core:permission-doctor:permission-doctor detect-suspicious \
