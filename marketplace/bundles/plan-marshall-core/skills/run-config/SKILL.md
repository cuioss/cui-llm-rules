...
```bash
python3 .plan/execute-script.py plan-marshall-core:run-config:run-config init
```
...
test -f {run-config-file} || \
  python3 .plan/execute-script.py plan-marshall-core:json-file-operations:manage-json-file write {run-config-file} \
...
python3 .plan/execute-script.py plan-marshall-core:json-file-operations:manage-json-file read {run-config-file}

# Read specific command entry
python3 .plan/execute-script.py plan-marshall-core:json-file-operations:manage-json-file read-field {run-config-file} \
...
python3 .plan/execute-script.py plan-marshall-core:json-file-operations:manage-json-file update-field {run-config-file} \
...
```bash
python3 .plan/execute-script.py plan-marshall-core:run-config:run-config validate {run-config-file}
```
...
| Script | Notation |
|--------|----------|
| init-run-config | `plan-marshall-core:run-config:run-config` |
| validate-run-config | `plan-marshall-core:run-config:run-config` |
...
- Lessons learned are stored separately via `plan-marshall-core:lessons-learned` skill
