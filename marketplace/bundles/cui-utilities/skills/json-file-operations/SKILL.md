...
- Works with any JSON file (including .claude/ and .cui/ directories)
...
- Use portable notation: `cui-utilities:json-file-operations/scripts/manage-json-file.py`

### With claude-memory Skill
- Provides low-level JSON operations used by memory layer

### With claude-run-configuration Skill
