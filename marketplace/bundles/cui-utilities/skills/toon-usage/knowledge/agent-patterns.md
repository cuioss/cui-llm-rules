...
Agent handoff and memory persistence patterns using TOON format for token-efficient communication in cui-llm-rules marketplace.
...
**Storage**: `.cui/memory/task-history.toon`
...
**Storage**: `.cui/memory/analysis-state.toon`
...
- cui-task-workflow:workflow-patterns - Agent handoff workflow patterns
- cui-utilities:claude-memory - Memory layer operations

### Template Files
When TOON migration is complete, template files will be available at:
- `marketplace/bundles/cui-task-workflow/skills/workflow-patterns/templates/handoff-minimal.toon`
- `marketplace/bundles/cui-task-workflow/skills/workflow-patterns/templates/handoff-standard.toon`
- `marketplace/bundles/cui-task-workflow/skills/workflow-patterns/templates/handoff-full.toon`
