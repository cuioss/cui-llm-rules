---
name: toon-usage
description: TOON format knowledge and usage patterns for agent communication and memory persistence in cui-llm-rules marketplace
allowed-tools: Read
---
...
- **Designing memory persistence** - Need structured data storage in .cui/memory/
...
**Purpose**: Structured session data storage in `.cui/memory/`.
...
### 3. Internal Use Only
TOON is for cui-llm-rules marketplace internal operations, not external APIs.
