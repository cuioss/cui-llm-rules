#!/usr/bin/env python3
"""Direct command execution foundation layer for Gradle.
...
Usage:
    ...
    from gradle_direct_command import execute_direct, detect_wrapper
    ...
    # As CLI
    python3 gradle_direct_command.py execute --args "build" --command-key "gradle:build" --default-timeout 300
"""
