...
model: sonnet
skills: pm-dev-java:java-solution-outline, pm-core:general-development-rules
---
...
```
Skill: pm-dev-java:java-solution-outline
...
component: "pm-dev-java:java-solution-outline"
