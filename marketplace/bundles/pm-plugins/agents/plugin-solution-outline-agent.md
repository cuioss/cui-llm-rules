...
model: sonnet
skills: pm-plugins:plugin-solution-outline, pm-core:general-development-rules
---

# Plugin Solution Outline Agent

Constrained specialist for plugin solution outline creation. Delegates to `pm-plugins:plugin-solution-outline` skill.
...
```
Skill: pm-plugins:plugin-solution-outline
...
component: "pm-plugins:plugin-solution-outline"
