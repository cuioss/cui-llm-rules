...
model: sonnet
skills: pm-plugins:plugin-task-plan, pm-core:general-development-rules
---

# Plugin Task Plan Agent

Constrained specialist for plugin task planning. Delegates to `pm-plugins:plugin-task-plan` skill.
...
```
Skill: pm-plugins:plugin-task-plan
...
component: "pm-plugins:plugin-task-plan"
