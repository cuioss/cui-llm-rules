...
|-----------|-------------|---------|
| `bundle` | Bundle name (from plugin.json) | `pm-plugins` |
...
```
pm-documents:cui-documentation/scripts/asciidoc-validator.sh
pm-plugins:plugin-doctor/scripts/analyze-markdown-file.sh
```
...
pm-java:cui-java-core/scripts/analyze-logging-violations.py
