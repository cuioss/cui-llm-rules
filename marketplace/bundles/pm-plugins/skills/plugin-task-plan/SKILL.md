...
|-----------|-----------|-------------|
| create | skill | `pm-plugins:plugin-create` → create-skill |
| create | command | `pm-plugins:plugin-create` → create-command |
| create | agent | `pm-plugins:plugin-create` → create-agent |
| create | bundle | `pm-plugins:plugin-create` → create-bundle |
| modify | any | `pm-plugins:plugin-maintain` → update-component |
| refactor | any | `pm-plugins:plugin-maintain` → refactor-structure |
...
Steps:
1. Load skill: pm-plugins:plugin-create
...
Steps:
1. Load skill: pm-plugins:plugin-maintain
...
**Caller**: `pm-plugins:plugin-task-plan-agent`
...
**Skills Delegated To**:
- `pm-plugins:plugin-create` - Component creation (handles validation and verification internally)
- `pm-plugins:plugin-maintain` - Component updates and refactoring (handles verification internally)
