...
### Related Skills
- pm-core:general-development-rules - Core development principles
- pm-core:diagnostic-patterns - Tool usage patterns
- pm-plugins:plugin-script-architecture - Python implementation, testing, output contracts
