...
```
Task:
  subagent_type: pm-plugins:my-agent
...
**Physical Location**:
```
marketplace/bundles/pm-plugins/skills/cui-marketplace-architecture/scripts/analyze-skill-structure.sh
```
...
```yaml
tools: Read, Bash(./marketplace/bundles/pm-plugins/skills/cui-marketplace-architecture/scripts/analyze-skill-structure.sh:*)
```
...
```json
{
  "permissions": {
    "allow": [
      ...
      "Bash(./marketplace/bundles/pm-plugins/skills/cui-marketplace-architecture/scripts/analyze-skill-structure.sh:*)",
