...
**Examples**:
```markdown
✅ python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze {input_file}
✅ python3 .plan/execute-script.py pm-plugins:plugin-doctor:validate {component_path}
...
Skill: pm-core:general-development-rules  # Pattern 5
