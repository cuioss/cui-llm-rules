...
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component generate --type "agent" --config "{answers_json}"
```
...
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component validate --file "{file_path}" --type "agent"
```
...
```
SlashCommand: /pm-plugins:plugin-doctor agents agent-name={agent-name}
```
...
**Generate frontmatter:**
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component generate --type "command" --config "{answers_json}"
```
...
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component validate --file "{file_path}" --type "command"
```
...
```
SlashCommand: /pm-plugins:plugin-doctor commands command-name={command-name}
```
...
Generate frontmatter:
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component generate --type "skill" --config "{answers_json}"
```
...
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component validate --file "{skill_path}/SKILL.md" --type "skill"
```
...
```
SlashCommand: /pm-plugins:plugin-doctor skills skill-name={skill-name}
```
...
```
SlashCommand: /pm-plugins:plugin-doctor metadata
```
...
Script: `pm-plugins:plugin-create` → `component.py`
...
**Usage**:
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component validate --file <file_path> --type <component_type>
```
...
**Usage**:
```bash
python3 .plan/execute-script.py pm-plugins:plugin-create:component generate --type <component_type> --config '<answers_json>'
```
