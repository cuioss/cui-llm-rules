...
Task: subagent_type="pm-plugins:diagnose-agent"
Parameters:
  file_path: {file_path}
  mode: "strict"
...
Sort bundles: pm-plugins first, then alphabetically.
...
Skill: pm-core:diagnostic-patterns
Skill: pm-core:marketplace-inventory
Skill: pm-plugins:bundle-orchestration-compliance
...
**Diagnosis**:
```bash
Bash: python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze validate-references {command_path}
