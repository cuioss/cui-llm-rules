...
**Scripts**:
```bash
Bash: python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze {file_path}
Bash: python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze validate-refs {component}
```
...
Skill Pair: pm-java:cui-java-core ↔ pm-java:cui-java-cdi
...
- **Usage**:
  ```bash
  Bash: python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze {file_path} agent
  ```
...
- **Usage**:
  ```bash
  Bash: python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze validate-references {component_path}
  ```
```
...
**Diagnosis**:
```bash
Bash: python3 .plan/execute-script.py pm-plugins:plugin-doctor:analyze validate-references {skill_dir}/SKILL.md
