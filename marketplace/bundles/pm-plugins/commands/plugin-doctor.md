...
This command delegates to `pm-plugins:plugin-doctor` skill which is designed to run without user prompts for safe operations:
...
2. **Record lesson** with:
   - Component: `{type: "command", name: "plugin-doctor", bundle: "pm-plugins"}`
