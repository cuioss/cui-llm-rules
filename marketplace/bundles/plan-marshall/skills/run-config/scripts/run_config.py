...
"""
    ...
    p_profile_set.add_argument(
        '--profile-id',
        required=True,
        help='Profile identifier (e.g., "jfr", "benchmark")'
    )
    p_profile_set.add_argument(
        '--canonical',
        required=True,
    ...
    ext_defaults_subparsers = p_ext_defaults.add_subparsers(dest='ext_defaults_command', help='Extension defaults operation')
    ...
    p_ext_defaults_set_default = ext_defaults_subparsers.add_parser('set-default', help='Set value only if key does not exist (write-once)')
