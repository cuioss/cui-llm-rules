...
**Resolution**: Run `/plan-marshall --wizard` or select "Full Reconfigure" from Configuration menu.
...
2. Or delete the file and run `/plan-marshall --wizard`
...
recovery: Ensure skill invoked via /plan-marshall command
```

**Resolution**: Use the `/plan-marshall` command to invoke this skill properly.
