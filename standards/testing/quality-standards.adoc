...
* **Mockito**: Do NOT use for mocking - use CUI framework alternatives instead. Or EasyMock for simple mocking scenarios.
* **PowerMock**: Do NOT use for advanced mocking scenarios - refactor to use dependency injection. Or EasyMock for simple mocking scenarios.
* **Hamcrest**: Do NOT use for assertions - use JUnit 5 assertions exclusively

**Migration Guidelines:**

* Replace Mockito with CUI framework dependency injection patterns. Or EasyMock for simple mocking scenarios.
