...
3. **Post-Change Verification**: After any dependency changes, follow the verification process in <<../process/task-completion-standards.adoc#,Task Completion Standards>>:
...
5. Follow <<../process/task-completion-standards.adoc#,Task Completion Standards>> for final verification before committing

=== JavaScript Continuous Integration
JavaScript projects must pass these checks in CI, as defined in <<../process/task-completion-standards.adoc#,Task Completion Standards>>:
