...
==== Quarkus Native Optimization Process [MIGRATED]
**MIGRATED** to marketplace: `/cui-quarkus-native-optimize` command in cui-java-expert bundle.
Systematic process for optimizing Quarkus applications for native image compilation with reflection registration optimization. Standards documented in cui-java-cdi skill (quarkus-native.md); orchestration via command.
...
==== POM Maintenance Process [MIGRATED]
**MIGRATED** to marketplace: `pom-maintenance.md` standard in cui-maven-rules skill (cui-maven bundle).
Process for maintaining and optimizing Maven POM files across Java projects. Standards documented in skill; execution via maven-builder agent.
...
* **Code Refactoring**: Use `/cui-java-refactor` command (cui-java-expert bundle)
* **Quarkus Native Optimization**: Use `/cui-quarkus-native-optimize` command (cui-java-expert bundle)
...
* **Maven POM Maintenance**: Use cui-maven-rules skill (pom-maintenance.md standard)
